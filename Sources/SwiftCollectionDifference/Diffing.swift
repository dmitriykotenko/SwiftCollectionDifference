...
extension SwiftCollectionDifference {
...
extension RangeReplaceableCollection {
  ...
  public func applying(_ difference: SwiftCollectionDifference<Element>) -> Self? {
...
extension BidirectionalCollection {
  ...
  public func getDifference<C: BidirectionalCollection>(
    from other: C,
    by areEquivalent: (C.Element, Element) -> Bool
  ) -> SwiftCollectionDifference<Element>
...
extension BidirectionalCollection where Element: Equatable {
  ...
  public func getDifference<C: BidirectionalCollection>(
    from other: C
  ) -> SwiftCollectionDifference<Element> where C.Element == Self.Element {
    return getDifference(from: other, by: ==)
  }
}
...
) -> SwiftCollectionDifference<C.Element>
where
...
C.Element == D.Element
{
  ...
  func _formChanges(
    ...
    using trace: [_V]
  ) -> [SwiftCollectionDifference<C.Element>.Change] {
    var changes = [SwiftCollectionDifference<C.Element>.Change]()
  ...
  return _withContiguousStorage(for: old) { a in
    return _withContiguousStorage(for: new) { b in
      return SwiftCollectionDifference(_formChanges(from: a, to: b, using:_descent(from: a, to: b)))!
    }
  }
}
