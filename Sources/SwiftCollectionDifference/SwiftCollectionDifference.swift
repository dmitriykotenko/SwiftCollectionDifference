...
public struct SwiftCollectionDifference<ChangeElement> {
  ...
  public init?<Changes: Collection>(
    ...
    guard SwiftCollectionDifference<ChangeElement>._validateChanges(changes) else {
      return nil
    }
  ...
  /// `CollectionDifferenceForTests.init?(_:)` should be used instead.
  ///
  ...
  ///
  /// - Parameter changes: a collection of `CollectionDifferenceForTests.Change`
  ///   instances intended to represent a valid state transition for
  ///   `CollectionDifferenceForTests`.
  ///
  ...
  public func inverse() -> Self {
    return SwiftCollectionDifference(_validatedChanges: self.map { c in
      switch c {
...
/// A CollectionDifferenceForTests is itself a Collection.
///
...
/// }
/// ```
extension SwiftCollectionDifference: Collection {
...
extension SwiftCollectionDifference.Index: Equatable {
  @inlinable
  public static func == (
    lhs: SwiftCollectionDifference.Index,
    rhs: SwiftCollectionDifference.Index
  ) -> Bool {
    return lhs._offset == rhs._offset
  }
}

extension SwiftCollectionDifference.Index: Comparable {
  @inlinable
  public static func < (
    lhs: SwiftCollectionDifference.Index,
    rhs: SwiftCollectionDifference.Index
...
extension SwiftCollectionDifference.Index: Hashable {
  @inlinable
...
extension SwiftCollectionDifference.Change: Equatable where ChangeElement: Equatable {}

extension SwiftCollectionDifference: Equatable where ChangeElement: Equatable {}

extension SwiftCollectionDifference.Change: Hashable where ChangeElement: Hashable {}

extension SwiftCollectionDifference: Hashable where ChangeElement: Hashable {}

extension SwiftCollectionDifference where ChangeElement: Hashable {
  ...
  public func inferringMoves() -> SwiftCollectionDifference<ChangeElement> {
    ...
    return SwiftCollectionDifference(_validatedChanges: map({ (change: Change) -> Change in
      switch change {
...
extension SwiftCollectionDifference.Change: Codable where ChangeElement: Codable {
...
extension SwiftCollectionDifference: Codable where ChangeElement: Codable {}

extension SwiftCollectionDifference: Sendable where ChangeElement: Sendable { }
extension SwiftCollectionDifference.Change: Sendable where ChangeElement: Sendable { }
extension SwiftCollectionDifference.Index: Sendable where ChangeElement: Sendable { }
